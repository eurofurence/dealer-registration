        ...
        <button class="accordion-button block" type="button" data-bs-toggle="collapse" data-bs-target="#profile-form-item"
            ...
            <div class="row">
                ...
                <div class="col-10">
                    ...
                    information even after the registration period has ended.
                </div>
            </div>
        </button>
    </h2>
        ...
        <div class="accordion-body mt-2">
            @if ($applicationType === \App\Enums\ApplicationType::Share)
                ...
                <label class="form-check-label" for="dd-profile-hidden">
                    <strong>Hide Profile</strong> – I wish to share the dealership's profile instead of providing my
                    own.
                </label>
            @endif
            <div id="dd-profile">
                ...
                <div class="row mb-1">
                    <div class="col-sm-10 offset-sm-2">
                        <div class="form-check">
                            <input class="form-check-input @error('attends_thu') is-invalid @enderror"
                                name="attends_thu" @checked(old('_token') ? old('attends_thu') : $profile?->attends_thu === true) type="checkbox" id="attends_thu">
                ...
                <div class="row mb-1">
                    <div class="col-sm-10 offset-sm-2">
                        <div class="form-check">
                            <input class="form-check-input @error('attends_fri') is-invalid @enderror"
                                name="attends_fri" @checked(old('_token') ? old('attends_fri') : $profile?->attends_fri === true) type="checkbox" id="attends_fri">
                ...
                <div class="row mb-1">
                    <div class="col-sm-10 offset-sm-2">
                        <div class="form-check">
                            <input class="form-check-input @error('attends_sat') is-invalid @enderror"
                                name="attends_sat" @checked(old('_token') ? old('attends_sat') : $profile?->attends_sat === true) type="checkbox" id="attends_sat">
                ...
                <div class="row mb-3 mt-5">
                    <label for="short_desc" class="col-sm-2 col-form-label fw-bold">Short
                        De&shy;scrip&shy;tion</label>
                    <div class="col-sm-10">
                ...
                <div class="row mb-1 mt-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="modal fade" id="imageArtModal" tabindex="-1"
                            aria-labelledby="imageArtModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div id="art_preview_captionHelp" class="form-text">
                            If you have uploaded an art/merchandise preview image above, you can enter a description
                            that is
                ...
                <div class="row mb-3 mt-5">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="profile_website"
                            placeholder="https://yourprofile.example.com/itsme"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div id="telegramHelp" class="form-text">
                            Promote your Telegram channel or allow people to get in touch with you personally via
                            Telegram.
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-3 mt-5">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div id="tweetHelp" class="form-text">
                            A short text which the Dealers' Den team can publish on Twitter and Telegram. By filling in
                            this
