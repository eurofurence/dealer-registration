    ...
    <div class="card-body">
        ...
        @if ($applicationType === \App\Enums\ApplicationType::Dealer || $applicationType === \App\Enums\ApplicationType::Share)
            ...
            <div class="row mb-1">
                <div class="col-sm-10 offset-sm-2">
                    <div class="form-check">
                        <input class="form-check-input" name="attends_thu" @checked(old('attends_thu') ?? $profile?->attends_thu === true)
                            type="checkbox" id="attends_thu">
            ...
            <div class="row mb-1">
                <div class="col-sm-10 offset-sm-2">
                    <div class="form-check">
                        <input class="form-check-input" name="attends_fri" @checked(old('attends_fri') ?? $profile?->attends_fri === true)
                            type="checkbox" id="attends_fri">
            ...
            <div class="row mb-1">
                <div class="col-sm-10 offset-sm-2">
                    <div class="form-check">
                        <input class="form-check-input" name="attends_sat" @checked(old('attends_sat') ?? $profile?->attends_sat === true)
                            type="checkbox" id="attends_sat">
            ...
            <div class="row mb-1">
                <div class="col-sm-10 offset-sm-2">
                    <div class="form-check">
                        <input class="form-check-input" name="is_artwork" @checked(old('is_artwork') ?? $profile?->is_artwork === true)
                            type="checkbox" id="is_artwork">
            ...
            <div class="row mb-1">
                <div class="col-sm-10 offset-sm-2">
                    <div class="form-check">
                        <input class="form-check-input" name="is_fursuit" @checked(old('is_fursuit') ?? $profile?->is_fursuit === true)
                            type="checkbox" id="is_fursuit">
            ...
            <div class="row mb-1">
                <div class="col-sm-10 offset-sm-2">
                    <div class="form-check">
                        <input class="form-check-input" name="is_commissions" @checked(old('is_commissions') ?? $profile?->is_commissions === true)
                            type="checkbox" id="is_commissions">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    @if ($profile?->image_thumbnail != null && file_exists(public_path('/images/upload/' . $profile?->image_thumbnail)))
                        <img id='image_thumbnail_preview'
                            src="{{ asset('/images/upload/' . $profile?->image_thumbnail) }}" style="height: 100px;">
                    @else
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea rows="5" type="text" name="art_desc"
                        class="form-control @error('art_desc') is-invalid @enderror" id="art_desc">{{ old('art_desc') ?? $profile?->art_desc }}</textarea>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea rows="1" type="text" name="telegram"
                        class="form-control @error('telegram') is-invalid @enderror" id="telegram">{{ old('telegram') ?? $profile?->telegram }}</textarea>
