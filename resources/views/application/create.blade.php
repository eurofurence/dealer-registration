            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="merchandise" value="{{ old('merchandise') }}"
                        ...
                        <div class="col-sm-10">
                            <div class="form-check">
                                <input class="form-check-input @error('denType') is-invalid @enderror" type="radio"
                                       ...
                                       value="denTypeRegular" @if(old('denType') === "denTypeRegular") checked @endif>
                            ...
                            <div class="form-check">
                                <input class="form-check-input @error('denType') is-invalid @enderror" type="radio"
                                       ...
                                       @if(old('denType') === "denTypeAfterDark") checked @endif>
                        ...
                        <div class="col-sm-10">
                            <select name="space" id="space" class="form-select @error('space') is-invalid @enderror">
                                @foreach($table_types as $type)
                                    <option value="{{ $type['id'] }}" @selected(old('space',$type['id'] === 2)) >{{ $type['name'] }}</option>
                                @endforeach
                            </select>
                            @error('space')
                            <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-sm-10 offset-sm-2">
                            <div class="form-check">
                                <input class="form-check-input" name="wallseat"
                                       @checked(old('wallseat')) type="checkbox" id="wallseat">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-10 offset-sm-2">
                            <div class="form-check">
                                <input class="form-check-input" name="power" @checked(old('power')) type="checkbox"
                                       id="power">
                    ...
                    <textarea rows="5" type="text" name="unwanted"
                              ...
                              id="unwanted">{{ old('unwanted') }}</textarea>
                            @error('unwanted')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    @csrf
                    <button class="w-100 btn btn-primary btn-lg mt-4" type="submit">Submit Application</button>
                </div>
            </div>
        </form>
    </div>
