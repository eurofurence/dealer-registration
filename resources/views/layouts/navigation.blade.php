...
<nav class="py-2 bg-primary navbar-dark border-bottom">
    <div class="container d-flex flex-wrap">
        <ul class="nav me-auto">
            ...
            <li class="nav-item">
                <a href="{{ config('ef.dealers_tos_url') }}" class="nav-link link-light px-2"
                   aria-current="page">Dealers’ Den Rules & Information</a>
            </li>
        </ul>
        <ul class="nav">
            <div class="dropdown">
...
<header class="py-3 px-2 mb-4 border-bottom bg-white">
    <div class="container">
        <div class="d-flex align-items-baseline mb-3 mb-lg-0 me-lg-auto text-dark text-decoration-none">
            <span class="fs-4 px-2">Eurofurence dealers registration</span>
