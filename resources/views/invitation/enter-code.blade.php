    ...
    <div class="">
        <div class="col-md-6 mx-auto">
            ...
            <p class="text-center lead">If you have been given an Invite Code, you can enter it here to join another dealer.
                ...
                Please note that you can only have one application. If you already applied as a regular dealer, you will
                lose your space when joining another dealer as you will share their space.
            </p>
        </div>
