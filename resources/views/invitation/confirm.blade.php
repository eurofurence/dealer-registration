        ...
        <div class="mx-auto">
            ...
            @if ($invitationType === \App\Enums\ApplicationType::Share)
                <p class="text-center lead">
                    ...
                    additional information, please read the <a href="{{ config('convention.dealers_tos_url') }}"
            ...
            @elseif ($invitationType === \App\Enums\ApplicationType::Assistant)
                <p class="text-center lead">
                    ...
                    they have. For additional information, please read the <a href="{{ config('convention.dealers_tos_url') }}"
                        target="_blank">Dealers’ Den Rules & Information</a>.
                </p>
            @endif
