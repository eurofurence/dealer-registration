...
Route::middleware(['auth:web', \App\Http\Middleware\ForceOverseatingRedirectMiddleware::class])->group(function () {
    ...
    Route::post('applications', [\App\Http\Controllers\Application\ApplicationController::class, 'store'])->name('applications.store');
    ...
    //TODO move to admin group
    Route::get('admin/profiles/csv', [ProfileController::class, 'exportCsv']);
    Route::get('admin/profiles/images', [ProfileController::class, 'exportImages']);
});