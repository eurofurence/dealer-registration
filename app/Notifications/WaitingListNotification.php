...
class WaitingListNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject(config('ef.con_name') . ' Dealers\' Den - Application on Waiting List')
            ->greeting("Dear " . $notifiable->name . ",")
            ->line('Thank you for submitting your application to sell your amazing art and items at the upcoming ' . config('ef.con_name') . ' and your patience while we have been reviewing the dealer applications.')
            ...
            ->line('Thank you for your understanding and cooperation. We appreciate your interest in the ' . config('ef.con_name') . ' Dealers\' Den, and we hope that we will be able to work with you in the future.')
