...
class TableAcceptedShareNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line('Your Dealership has successfully confirmed its package at the ' . config('convention.con_name') . ' Dealers\' Den. We are excited to have you join us as a dealer at the convention!')
