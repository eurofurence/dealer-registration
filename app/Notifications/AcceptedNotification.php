...
class AcceptedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line(new HtmlString('To confirm your placement as a dealer at Eurofurence, please click on the approval button below. By clicking on this button, you are confirming to abide by the <a href="'. config('ef.dealers_tos_url') .'">Dealers\' Den\'s terms and conditions</a> and the Dealership fee will be added to your Eurofurence Registration.'))
