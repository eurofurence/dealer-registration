...
class TableOfferedShareNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line('We are thrilled to inform you that the application for the dealership at ' . config('convention.con_name') . ' which you are part of has been accepted! Congratulations!')
            ...
            ->line('Please note that you are required to pay all fees, including the Eurofurence event registration fee, within ' . config('convention.payment_timeframe') . ' of receiving this email to secure your placement as a dealer. If payment is overdue, Dealers\' Den management may void your placement.')
